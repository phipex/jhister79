...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2022-09-19T19:33').blur().should('have.value', '2022-09-19T19:33');

      cy.get(`[data-cy="endDate"]`).type('2022-09-19T02:31').blur().should('have.value', '2022-09-19T02:31');
