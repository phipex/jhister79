    ...
    <Row>
      <Col md="8">
        <h2 data-cy="departmentDetailsHeading">
          <Translate contentKey="jhister79App.department.detail.title">Department</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="departmentName">
              <Translate contentKey="jhister79App.department.departmentName">Department Name</Translate>
            </span>
          </dt>
          <dd>{departmentEntity.departmentName}</dd>
          <dt>
            <Translate contentKey="jhister79App.department.location">Location</Translate>
          </dt>
