  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhister79App.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="jhister79App.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhister79App.employee.firstName')}
              ...
              <ValidatedField
                label={translate('jhister79App.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('jhister79App.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('jhister79App.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('jhister79App.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('jhister79App.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('jhister79App.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('jhister79App.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('jhister79App.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
