...
import co.com.ies.pruebas.repository.CountryRepository;
import co.com.ies.pruebas.service.CountryService;
...
/**
 * REST controller for managing {@link co.com.ies.pruebas.domain.Country}.
 */
@RestController
@RequestMapping("/api")
