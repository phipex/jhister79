...
import co.com.ies.pruebas.repository.DepartmentRepository;
import co.com.ies.pruebas.service.DepartmentService;
...
/**
 * REST controller for managing {@link co.com.ies.pruebas.domain.Department}.
 */
@RestController
@RequestMapping("/api")
