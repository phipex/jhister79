...
import co.com.ies.pruebas.repository.EmployeeRepository;
import co.com.ies.pruebas.service.EmployeeService;
...
/**
 * REST controller for managing {@link co.com.ies.pruebas.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
