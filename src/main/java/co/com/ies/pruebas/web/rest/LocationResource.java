...
import co.com.ies.pruebas.repository.LocationRepository;
import co.com.ies.pruebas.service.LocationService;
...
/**
 * REST controller for managing {@link co.com.ies.pruebas.domain.Location}.
 */
@RestController
@RequestMapping("/api")
