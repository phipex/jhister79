...
import co.com.ies.pruebas.repository.JobHistoryRepository;
import co.com.ies.pruebas.service.JobHistoryService;
...
/**
 * REST controller for managing {@link co.com.ies.pruebas.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
